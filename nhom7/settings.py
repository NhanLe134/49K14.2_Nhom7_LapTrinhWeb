"""
Django settings for nhom7 project.
...
SECRET_KEY = 'django-insecure-jn-t*k5pknt^a3u67u8#s@yos@(k-ke1rc66wyyb+$hw(grm(n'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'nhaxe.context_processors.notifications',
                'nhaxe.context_processors.user_info',
            ],
        },
    },
]

WSGI_APPLICATION = 'nhom7.wsgi.application'
