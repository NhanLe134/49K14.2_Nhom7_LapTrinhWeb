...
urlpatterns = [
    ...
    path('quanlytuyenxe/them-tuyen-xe/', tuyenxe_views.them_tuyen_xe, name='them_tuyen_xe'),
    path('quanlytuyenxe/sua-tuyen-xe/<str:pk>/', tuyenxe_views.sua_tuyen_xe, name='sua_tuyen_xe'),
    path('quanlytuyenxe/xoa-tuyen-xe/<str:pk>/', tuyenxe_views.xoa_tuyen_xe, name='xoa_tuyen_xe'),
